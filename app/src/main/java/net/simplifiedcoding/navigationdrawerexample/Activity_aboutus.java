...
public class Activity_aboutus extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat.getColor(Activity_aboutus.this, R.color.maroon_dark));
        }
    ...
    private void callapi()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://sighteat.com/imitra/api/selection/getContent//{\"Category\":\"About\"}",
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try
                        {
                            ...
                            else
                            {
                                ...
                                Intent intent = new Intent(Activity_aboutus.this, MainActivity.class);
