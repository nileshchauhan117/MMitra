...
public class MainActivity_Ca extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sm = new SessionManager(MainActivity_Ca.this);
        ...
        tv_usernames.setText(sm.getname()+" ("+sm.getloginid()+")");
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_menu1:
                fragment = new Menu1_Other();
                break;

            case R.id.nav_menu2:
                Intent i5=new Intent(getApplicationContext(),Activity_Current_Project_other.class);
                startActivity(i5);
                break;

            case R.id.nav_menu3:
                android.support.v7.app.AlertDialog.Builder dialog = new android.support.v7.app.AlertDialog.Builder(MainActivity_Ca.this);
                dialog.setCancelable(false);
                dialog.setMessage("Are you sure you want to Logout App?");
                dialog.setPositiveButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
                ...
                dialog.setNegativeButton("OK", new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        sm.logoutUser();
                        Intent intent = new Intent(MainActivity_Ca.this, Activity_Login.class);
                        startActivity(intent);
                        finish();
                    }
                });
    ...
    private void city()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://sighteat.com/imitra/api/selection/getCityList/{\"StateSrNo\":\"56\"}",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                // JSONObject object = jsonObject.getJSONObject("StateData");
                                //    String CityData=jsonObject.getString("CityData");
                                //Toast.makeText(getApplicationContext(),jsonObject+"",Toast.LENGTH_LONG).show();
                                Constants.city=jsonObject+"";
                                //object.getString("CurrentProjects");
    ...
    private void state()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://sighteat.com/imitra/api/selection/getStateList/",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response)
                    {
