...
public class SessionManager {
	...
	public void setUserId(String uid, String first_name, String last_name, String middle_name, String password, String client_type, String unique_id, String role_id, String email_id,String login_id) {
	...
	public String getto() {
		...
		String uName = pref.getString(KEY_PASSWORD, null);
	...
	public String getjs() {
		...
		String uName = pref.getString(KEY_CLIENT_TYPE, null);
	...
	public String getloginid() {
		...
		String uName = pref.getString(KEY_LOGINID, null);
	...
	public String getTokenID() {
		...
		String uName = pref.getString(KEY_MIDDLENAME, null);

		return uName;
	}
	public String getRelationID() {

		String uName = pref.getString(KEY_LASTNAME, null);
