...
public class Activity_Current_Project_other extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat.getColor(Activity_Current_Project_other.this, R.color.maroon_dark));
        }
        mShimmerViewContainer = findViewById(R.id.shimmer_view_container);
        sm = new SessionManager(Activity_Current_Project_other.this);
