...
public class web extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            getWindow().setStatusBarColor(ContextCompat.getColor(web.this, R.color.maroon_dark));
        }
        Intent intent = getIntent();
        url = intent.getStringExtra("https://docs.google.com/viewer?embedded = true&url = "+"url");
