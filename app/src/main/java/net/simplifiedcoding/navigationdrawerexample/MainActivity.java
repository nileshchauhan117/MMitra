        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(getApplicationContext()).load(sm.getTokenID()).placeholder(getResources().getDrawable(R.drawable.no_img)).error(getResources().getDrawable(R.drawable.no_img)).into(iv_user_pic);
