...
public class Activity_Tab_CreditOverdraft extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat.getColor(Activity_Tab_CreditOverdraft.this, R.color.maroon_dark));
        }
        ImageView back_btn;
        ...
        sm = new SessionManager(Activity_Tab_CreditOverdraft.this);
    ...
    {
        String u=Constants.URL+"selection/getProjectList/{\"mode\":\"list\",\"ProjectID\":\""+ProjectID+"\",\"Screen\":\"CashOverdraftList\"," +"\"RecordType\":\""+"P"+"\"}";
        Log.e("Url",u);
