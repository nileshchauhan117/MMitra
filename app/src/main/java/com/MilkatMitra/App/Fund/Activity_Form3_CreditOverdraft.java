...
public class Activity_Form3_CreditOverdraft extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat.getColor(Activity_Form3_CreditOverdraft.this, R.color.maroon_dark));
        }
        ImageView back_btn;
        ...
        title1.setText("Cash Credit/OverDraft");
        container_plan = (LinearLayout)findViewById(R.id.container_plan);
        Intent intent = getIntent();
        ProjectID = intent.getStringExtra("ProjectID");
        sm = new SessionManager(Activity_Form3_CreditOverdraft.this);
        ...
        txtsub_Overdraft.setBackgroundResource(R.color.maroon_tra);
    ...
    {
        String u=Constants.URL+"selection/getProjectList/{\"mode\":\"list\",\"ProjectID\":\""+ProjectID+"\",\"Screen\":\"CashOverdraftList\"," +"\"RecordType\":\""+"A"+"\"}";
        Log.e("Url",u);
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try
                        {
                            ...
                            if(jsonObject.getString("Code").equals("200"))
                            {
                                ...
                                int i=0;
                                String  ConstructionCost= array.getJSONObject(i).getString("CashOverdraftList");
