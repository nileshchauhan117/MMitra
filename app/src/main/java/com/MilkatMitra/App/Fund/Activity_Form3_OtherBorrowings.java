...
public class Activity_Form3_OtherBorrowings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat.getColor(Activity_Form3_OtherBorrowings.this, R.color.maroon_dark));
        }
       TextView title1=(TextView)findViewById(R.id.title1) ;
        title1.setText("Other Borrowings");
        ImageView back_btn;
        ...
        sm = new SessionManager(Activity_Form3_OtherBorrowings.this);
        ...
        txtsub_Other_Borrowings.setBackgroundResource(R.color.maroon_tra);
    ...
    {
        String u=Constants.URL+"selection/getProjectList/{\"mode\":\"list\",\"ProjectID\":\""+ProjectID+"\",\"Screen\":\"OtherBorrowingList\"," +"\"RecordType\":\""+"A"+"\"}";
        Log.e("Url",u);
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try
                        {
                            ...
                            if(jsonObject.getString("Code").equals("200"))
                            {
                                ...
                                int i=0;
                                String  ConstructionCost= array.getJSONObject(i).getString("OtherBorrowingList");
